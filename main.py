...
def start_typing():
    ...
    def start_timer(count):
        ...
        if times_up:
            ...
            speed_label = Label(text=f"wpm : {formatted_net_wpm} words", font=("Courier", 30), foreground="#F0A500",
                                background="#222831", padx=20, pady=20)
            speed_label.pack()

            accuracy_label = Label(text=f"Accuracy : {formatted_accuracy} ", font=("Courier", 30), foreground="#F0A500",
                                   background="#222831", padx=20, pady=20)
            accuracy_label.pack()

            play_again = Button(text="Start Again", font=("Courier", 30), bg="#F0A500", activebackground="#F0A500",
                                padx=20, pady=20)
